...
df2=pd.read_csv('output_test/group_{}/counting_table/phyla_table.txt'.format(group), sep='\t', header=0)
...
df2.to_csv('output_test/group_{}/counting_table/phyla_table.txt'.format(group),sep='\t',index=False)
