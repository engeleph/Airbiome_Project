...
prepare_megandb(){
   ...
   if [ -d "${REFERENCE_FOLDER}/reference_database/megan_ref" ]; then
      ...
      wget https://software-ab.cs.uni-tuebingen.de/download/megan6/prot_acc2tax-Jul2019X1.abin.zip
      ...
      wget https://software-ab.cs.uni-tuebingen.de/download/megan6/acc2kegg-Jul2019X-ue.abin.zip
      unzip acc2kegg-Jul2019X-ue.abin.zip
      wget https://software-ab.cs.uni-tuebingen.de/download/megan6/acc2interpro-Jul2019X.abin.zip
      unzip acc2interpro-Jul2019X.abin.zip
      wget https://software-ab.cs.uni-tuebingen.de/download/megan6/acc2eggnog-Jul2019X.abin.zip
      unzip acc2eggnog-Jul2019X.abin.zip
      wget https://software-ab.cs.uni-tuebingen.de/download/megan6/acc2seed-May2015XX.abin.zip
