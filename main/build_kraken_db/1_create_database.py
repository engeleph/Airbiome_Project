...
try:
    ...
    if os.path.exists('ar53_metadata.tsv'):
        ...
        os.system('wget -q https://data.gtdb.ecogenomic.org/releases/latest/ar53_metadata.tar.gz')
        os.system('tar -xf ar53_metadata.tar.gz')
        files = [f for f in os.listdir(os.getcwd()) if 'ar53_metadata' in f and 'tsv' in f][0]
        os.system('mv '+files+' ar53_metadata.tsv')
        print('Successfully downloaded and unzipped ar53_metadata.tar.gz and its now saved as ar53_metadata.tsv')
    if os.path.exists('bac120_metadata.tsv'):
        ...
        os.system('wget https://data.gtdb.ecogenomic.org/releases/latest/bac120_metadata.tar.gz')
...
try:
    if download_genomes != True:
        ...
        if os.path.exists('gtdb_genomes_reps/'):
            ...
            os.system('wget https://data.gtdb.ecogenomic.org/releases/latest/genomic_files_reps/gtdb_genomes_reps.tar.gz')
