...
pathogens=pd.read_csv("conf/pathogens.txt", sep=',', header=0, index_col=0)         #pathogens from data set can be found on: https://www.ncbi.nlm.nih.gov/pathogens/organisms/ 
